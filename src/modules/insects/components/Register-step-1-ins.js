...
import '../style/Register-step-1-ins.css';
    ...
    return (
        <div className="form-container">
            <form onSubmit={handleSubmit}>
                <h2>Registro de Especies - Paso 1</h2>
...
const Paso2 = ({ taxonSeleccionado, irAtras, irSiguiente }) => {
    ...
    return (
        <div className="form-container">
            <form onSubmit={handleSubmit}>
                <h2>Registro de Especies - Paso 2</h2>
...
const Paso3 = ({ irAtras, finalizar, taxonSeleccionado }) => {
    ...
    return (
        <div className="form-container">
            <form onSubmit={handleSubmit}>
                <h3>Registro de insectos - Paso 3</h3>
                <p><strong>Nombre de la especie seleccionada:</strong> {taxonSeleccionado}</p>
                ...
                <div className="form-grid-3">
                    ...
                    <div>
                        ...
                        <label htmlFor="estado-vida">Estado de vida</label>
                        <select
                            id="estado-vida"
                            value={estadoVida}
                            onChange={(e) => setEstadoVida(e.target.value)}
                        >
                            <option value="">Selecciona una opción</option>
                            {/* Opciones */}
                        </select>
